 ...
 * - Exercício 9
    ...
    todos os números (a partir de 1) até aquele colocado na operação. Veja os exemplos abaixo:
    ...
    Uma aplicação interessante do fatorial é o cálculo de anagramas de uma palavra. Anagrama é uma 
    outra palavra (não precisa existir em português) com as mesmas letras da anterior em ordem diferentes. 
